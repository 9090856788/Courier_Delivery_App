...
export const getDashboardsStatsData = async () => {
  ...
  for (const bucket of weightBucketAgg) {
    if (bucket._id === 0) {
      weightDistribution[0].count = bucket.count;
    } else if (bucket._id === 1) {
      weightDistribution[1].count = bucket.count;
    } else if (bucket._id === 2) {
      weightDistribution[2].count = bucket.count;
    } else if (bucket._id === 3) {
      weightDistribution[3].count = bucket.count;
    } else if (bucket._id === 4) {
